...
const Guide = () => {
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-20">
        ...
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          ...
          <p className="regular-16 text-gray-30 xl:max-w-[520px]">
            Only with the Campfire application you will no longer get lost and
      ...
      <div className="flexCenter max-container relative w-full sm:h-auto h-[245px]">
        <Image
          src="/boat.png"
          alt="boat"
          width={1440}
          height={580}
          className="w-full object-cover object-center 2xl:rounded-5xl sm:h-auto h-[100%]"
        />
        ...
        <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20">
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2">Sulfuric waters</p>
            </div>

            <div className="flex w-full flex-col">
              <p className="regular-16 text-gray-20">Start track</p>
              <h4 className="bold-20 mt-2 whitespace-nowrap">Gonio Fortress</h4>
            </div>
          </div>
        </div>
      </div>
